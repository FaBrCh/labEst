...
format: 
  html:
    ...
    theme: cosmo 
    code-fold: true
    code-summary: "Mostrar/Ocultar código da célula"
    code-link: true
    code-copy: true
    lightbox: true
    fig-width: 8
...
lang: pt
execute:
  echo: false # Oculta blocos de código por padrão
  warning: false
  message: false
---
...
```{r setup-libraries-and-data, echo=TRUE, collapse=TRUE}
...
```{r carac-categoricas-setup, echo=TRUE, collapse=TRUE}
...
```{r preparar-dados-likert-qmd, echo=TRUE, collapse=TRUE, eval=TRUE}
...
```{r setup-univariada, echo=TRUE, collapse=TRUE}
...
```{r teste-cargo-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-cargo-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-formacao-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-formacao-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-faixa-etaria-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-faixa-etaria-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-sexo, echo=TRUE, collapse=TRUE}
...
```{r teste-exp-total-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-exp-total-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-exp-aps-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-exp-aps-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-exp-vac-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-exp-vac-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-porte-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-porte-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-macro-kw, echo=TRUE, collapse=TRUE}
...
```{r teste-macro-pairwise, echo=TRUE, collapse=TRUE, eval=TRUE, results='asis'}
...
```{r teste-idhm, echo=TRUE, collapse=TRUE}
